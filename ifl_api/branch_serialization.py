"""將 ifl_branch 內部 dataclass 轉為 JSON 安全的 dict。

DecisionNode/ConditionSet/AtomicCondition 是 ifl_branch.models.decision_node 的
dataclass，AtomicCondition.ast_node 帶原始 ast.AST 節點，不可直接 JSON 化，
因此不能用 dataclasses.asdict() 一鍵轉換，需手動挑選欄位。
"""
from __future__ import annotations

from ifl_branch.models.decision_node import DecisionNode
